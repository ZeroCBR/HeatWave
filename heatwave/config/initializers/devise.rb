...
Devise.setup do |config|
  ...
  # random tokens.
  # Changing this key will render invalid all existing confirmation, reset
  # password and unlock tokens in the database.
  ...
  config.mailer_sender = 'heatwaveorange@gmail.com'
  ...
  # config.pepper = 'cc236cd3758db7d25f2e5aeb5820d2d84e6a3bf4198bc642cd54720d6'\
  # 'b82d1880f025be6fb9fcca3e4c4789a1e0c262f5383412019c2b2a883c275bbe3bd4981'
  ...
  # email db field (see migrations).
  # Until confirmed, new email is stored in unconfirmed_email column, and copied
