...
Gem::Specification.new do |spec|
  spec.name = 'puller'
  spec.version = Puller::VERSION
  spec.authors = ['Ned Pummeroy']
  spec.email = ['nedpummeroy@gmail.com']

  spec.summary = 'Pulls weather data from a given source.'
  spec.description = <<-EOF
    Uses a supplied data getter, data processor, and data saver
    to pull weather data from a specified online data source.
  EOF
